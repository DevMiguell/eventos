    ...
    return (
        <>
            ...
            <div className="login-content d-flex">
                <form className="text-center text-white form-signin mx-auto mx-auto mt-5">
                    ...
                    <button onClick={recuperarSenha} type="button" className="w-100 btn btn-lg btn-enviar">Recuperar Senha</button>
                </form>
            </div>
        </>
    )
